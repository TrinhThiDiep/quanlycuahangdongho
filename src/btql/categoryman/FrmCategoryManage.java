 ...
 * @author Computer
 */
public class FrmCategoryManage extends DataGridForm {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (result == JOptionPane.YES_OPTION) {
            try {
                CategoryDAO.instance.remove(selected);
                refresh(true);
            } catch (SQLException ex) {
                Logger.getLogger(FrmCategoryManage.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCategoryManage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmCategoryManage().setVisible(true);
            }
        });
    }
    ...
    public void refresh(boolean reset) {
        try {
            List<Category> items = CategoryDAO.instance.findAll(txtSearchQuery.getText());

            DefaultTableModel model = (DefaultTableModel) tblDataGrid.getModel();
            model.setRowCount(0);

            for (Category n : items) {
