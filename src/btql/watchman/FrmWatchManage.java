...
import static daos.WatchDAO.instance;
import dtos.User;
import dtos.Watch;
 ...
 * @author Computer
 */
public class FrmWatchManage extends DataGridForm {

    /**
     * Creates new form FrmWatchManage
     */
    public FrmWatchManage() {
        initComponents();
    ...
    private void initComponents() {
        ...
        cbOutOfStock.setText("Hết hàng");
        cbOutOfStock.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbOutOfStockActionPerformed(evt);
            }
        });
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (result == JOptionPane.YES_OPTION) {
            try {
                WatchDAO.instance.remove(selected);
                refresh(true);
            } catch (SQLException ex) {
                Logger.getLogger(FrmWatchManage.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void cbOutOfStockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbOutOfStockActionPerformed
        // TODO add your handling code here:
        refresh(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmWatchManage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmWatchManage().setVisible(true);
            }
        });
    }
    ...
    public void refresh(boolean reset) {
        try {
            ...
            for (WatchView n : items) {
                Object dataRow[] = new Object[7];
                dataRow[0] = n.getId();
                dataRow[1] = n.getTitle();
                dataRow[2] = n.getUsername();
                dataRow[3] = n.getQuantity();
                dataRow[4] = n.getUnitPrice();
                dataRow[5] = n.getVendorTitle();
                dataRow[6] = n.getCategoryTitle();
