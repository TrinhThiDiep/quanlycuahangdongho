...
import daos.UserDAO;
import static daos.UserDAO.instance;
import dtos.User;
 ...
 * @author Computer
 */
public class FrmUserManage extends DataGridForm {
    ...
    public FrmUserManage() {
        ...
        tblDataGrid.setModel(new DataTable(
                ...
                new String[]{
                    "ID", "Tên đăng nhập", "Tên nhân sự", "Quản lý"
                }
        ));
    }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        // Không được xoá user đang đăng nhập
        if (Config.getCurrentUserId() == selected) {
            return;
        }
        ...
        if (result == JOptionPane.YES_OPTION) {
            try {
                UserDAO.instance.remove(selected);
                refresh(true);
            } catch (SQLException ex) {
                Logger.getLogger(FrmUserManage.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmUserManage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmUserManage().setVisible(true);
            }
        });
    }
    ...
    public void refresh(boolean reset) {
        try {
            ...
            List<User> items = UserDAO.instance.findAll(txtSearchQuery.getText());
            ...
            for (User n : items) {
                ...
                dataRow[0] = n.getId();
                dataRow[1] = n.getUsername();
                dataRow[2] = n.getFullname();
                dataRow[3] = n.isIsOwner() ? "Quản lý" : "Nhân viên";
